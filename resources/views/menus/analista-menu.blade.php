...
<div class="flex flex-col items-center bg-gray-100 dark:bg-gray-900 pt-12 min-h-screen">
    ...
    <div class="flex flex-col gap-4 w-full max-w-sm">
        ...
        <a href="{{ route('procesos.malla') }}" class="menu-item bg-indigo-500 hover:bg-indigo-600 text-white py-3 px-6 rounded text-center font-medium">Bitácora de Procesos (Analistas)</a>
